...
import { applyReflection, defaultPersonalProfile, directionTerms, hydratePersonalProfile } from '../src/profile/personalModel';
...
export function runPersonalMemoryScenarioChecks() {
  ...
  const decision = rankForMoment(
    ...
    { kindAffinity: directed.kindAffinity, blockedExperienceIds: [], favoriteExperienceIds: [], recentExperienceIds: [], directionTerms: directionTerms(directed), durationBiasMinutes: 0, intensityBalance: 0 },
  );
