...
const styles = StyleSheet.create({
  ...
  onboardingTitle: { color: colors.bone, fontSize: 44, lineHeight: 50, letterSpacing: -1.1, fontWeight: '400', fontFamily: editorialFont, maxWidth: 430 },
  ...
  screenTitle: { color: colors.bone, fontSize: 40, lineHeight: 46, letterSpacing: -0.9, fontWeight: '400', fontFamily: editorialFont }, screenSubtitle: { color: colors.muted, fontSize: 15, lineHeight: 22, marginTop: 10 },
  ...
  heroTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, heroTime: { color: colors.bone, fontSize: 11, letterSpacing: 1.4 }, heroBottom: { gap: 11 }, heroTitle: { color: '#FFF9EF', fontSize: 38, lineHeight: 44, fontWeight: '400', fontFamily: editorialFont, letterSpacing: -0.7 }, heroPromise: { color: 'rgba(255,249,239,0.88)', fontSize: 16, lineHeight: 23, maxWidth: 390 }, heroGrounding: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 7, borderRadius: 99, borderWidth: 1, borderColor: 'rgba(164,197,93,0.35)', backgroundColor: 'rgba(5,10,12,0.55)', paddingHorizontal: 10, paddingVertical: 7 }, heroGroundingMark: { color: colors.green, fontSize: 9 }, heroGroundingText: { color: colors.bone, fontSize: 9, fontWeight: '700' }, heroFacts: { flexDirection: 'row', gap: 18, marginTop: 8 },
