...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.green, fontSize: 10, letterSpacing: 1.65, fontWeight: '700', marginBottom: 10 },
  ...
  heroTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, heroTime: { color: colors.bone, fontSize: 11, letterSpacing: 1.2, fontWeight: '600' }, heroBottom: { gap: 11 }, heroTitle: { color: colors.bone, fontSize: 37, lineHeight: 42, fontWeight: '700', fontFamily: appFont, letterSpacing: -1 }, heroPromise: { color: 'rgba(243,240,233,0.88)', fontSize: 16, lineHeight: 23, maxWidth: 390 }, heroGrounding: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 7, borderRadius: radii.pill, borderWidth: 1, borderColor: 'rgba(182,204,130,0.35)', backgroundColor: 'rgba(5,7,6,0.58)', paddingHorizontal: 11, paddingVertical: 7 }, heroGroundingMark: { color: colors.green, fontSize: 9 }, heroGroundingText: { color: colors.bone, fontSize: 9, fontWeight: '700' }, heroFacts: { flexDirection: 'row', gap: 18, marginTop: 8 },
  ...
  liveEvidenceCard: { borderRadius: radii.card, borderWidth: 1, borderColor: colors.line, borderLeftWidth: 3, borderLeftColor: colors.green, backgroundColor: colors.panel, padding: 16, gap: 12, marginBottom: 20 }, liveEvidenceTitle: { color: colors.green, fontSize: 9, letterSpacing: 1.35, fontWeight: '700' }, liveEvidenceRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 }, liveEvidenceDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: colors.green, marginTop: 5 }, liveEvidenceLabel: { color: colors.bone, fontSize: 12, lineHeight: 17, fontWeight: '600' }, liveEvidenceMeta: { color: colors.muted, fontSize: 9, lineHeight: 14, marginTop: 3 }, liveEvidenceCaution: { color: colors.muted, fontSize: 10, lineHeight: 15, borderTopWidth: 1, borderTopColor: colors.line, paddingTop: 10 }, expiredEvidenceCard: { borderRadius: radii.card, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel, padding: 15, marginBottom: 20 }, expiredEvidenceText: { color: colors.muted, fontSize: 11, lineHeight: 17, marginTop: 7 },
  ...
  meaningThreadCard: { borderRadius: radii.control, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel, padding: 16, marginBottom: 20 }, meaningThreadCompact: { marginTop: 14, marginBottom: 2 }, meaningThreadEyebrow: { color: colors.green, fontSize: 9, letterSpacing: 1.25, fontWeight: '700' }, meaningThreadLabel: { color: colors.bone, fontFamily: appFont, fontSize: 18, lineHeight: 24, fontWeight: '600', marginTop: 8 }, meaningThreadReason: { color: colors.muted, fontSize: 11, lineHeight: 17, marginTop: 7 },
  flowTitle: { color: colors.bone, fontSize: 38, lineHeight: 43, fontWeight: '700', fontFamily: appFont, letterSpacing: -1 },
  expectationCard: { borderRadius: radii.card, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel, padding: 18, marginTop: 22 }, expectationLabel: { color: colors.green, fontSize: 9, letterSpacing: 1.45, fontWeight: '700' }, expectationTitle: { color: colors.bone, fontSize: 22, lineHeight: 29, fontWeight: '600', marginTop: 9 }, expectationBody: { color: colors.muted, fontSize: 13, lineHeight: 20, marginTop: 8 },
  ...
  presenceScreen: { flex: 1, padding: 20, paddingTop: 14, paddingBottom: 22 }, presenceTopRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }, presenceActions: { flexDirection: 'row', alignItems: 'center', gap: 8 }, guideButton: { minHeight: 44, paddingHorizontal: 14, borderRadius: 22, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel, alignItems: 'center', justifyContent: 'center' }, guideButtonText: { color: colors.bone, fontSize: 12, fontWeight: '700' }, phoneAwayButton: { minHeight: 44, paddingHorizontal: 14, borderRadius: 22, borderWidth: 1, borderColor: colors.green, backgroundColor: 'rgba(182,204,130,0.08)', alignItems: 'center', justifyContent: 'center' }, phoneAwayButtonText: { color: colors.green, fontSize: 12, fontWeight: '700' }, presenceTitle: { color: colors.bone, fontSize: 36, lineHeight: 42, fontWeight: '700', fontFamily: appFont, textAlign: 'center' }, presenceCue: { color: colors.muted, fontSize: 15, lineHeight: 23, textAlign: 'center', maxWidth: 370, marginTop: 16 }, presenceUnit: { color: colors.muted, fontSize: 10, letterSpacing: 1.35, fontWeight: '600' }, presenceFooter: { color: colors.muted, fontSize: 10, lineHeight: 16, textAlign: 'center', marginTop: 9 },
