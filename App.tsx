...
const styles = StyleSheet.create({
  ...
  onboardingTitle: { color: colors.bone, fontSize: 42, lineHeight: 48, letterSpacing: -1.2, fontWeight: '700', fontFamily: appFont, maxWidth: 430 },
  ...
  memoryOutcomeRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 }, learningDisclosure: { minHeight: 70, borderRadius: 20, borderWidth: 1, borderColor: colors.line, backgroundColor: 'rgba(16,26,29,0.62)', padding: 15, marginBottom: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }, learningDisclosureTitle: { color: colors.bone, fontSize: 14, fontWeight: '700' }, learningDisclosureBody: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 4 },
