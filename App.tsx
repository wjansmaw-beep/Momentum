...
const styles = StyleSheet.create({
  ...
  resumeMarkText: { color: colors.accent, fontSize: 12 },
  ...
  heroTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, heroTime: { color: colors.onImage, fontSize: 12, letterSpacing: 1.2, fontWeight: '600' }, heroBottom: { gap: 11 }, heroTitle: { color: colors.onImage, fontSize: 37, lineHeight: 42, fontWeight: '700', fontFamily: appFont, letterSpacing: -1 }, heroPromise: { color: colors.onImageMuted, fontSize: 16, lineHeight: 23, maxWidth: 390 }, heroGrounding: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 7, borderRadius: radii.pill, borderWidth: 1, borderColor: 'rgba(255,253,248,0.28)', backgroundColor: colors.darkGlass, paddingHorizontal: 11, paddingVertical: 7 }, heroGroundingMark: { color: colors.onImageAccent, fontSize: 11 }, heroGroundingText: { color: colors.onImage, fontSize: 11, fontWeight: '700' }, heroFacts: { flexDirection: 'row', gap: 18, marginTop: 8 },
  heroWonder: { color: colors.onImage, fontSize: 15, lineHeight: 22, fontWeight: '600', marginTop: 2, maxWidth: 410 }, heroPrimaryAction: { minHeight: 58, borderRadius: 29, backgroundColor: 'rgba(252,250,245,0.96)', paddingHorizontal: 21, marginTop: 5, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 18, shadowOffset: { width: 0, height: 8 } }, heroPrimaryActionText: { color: colors.bone, fontSize: 16, fontWeight: '800' }, heroPrimaryActionArrow: { color: colors.accent, fontSize: 23 },
  ...
  suggestionArrowDisabled: { opacity: 0.22 }, suggestionArrowText: { color: colors.bone, fontSize: 20 }, suggestionPosition: { alignItems: 'center', flex: 1 }, suggestionDots: { flexDirection: 'row', gap: 6 }, suggestionDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.line }, suggestionDotActive: { width: 18, backgroundColor: colors.accent }, suggestionPositionBody: { color: colors.muted, fontSize: 11, marginTop: 6 },
  ...
  primaryButton: { minHeight: 56, borderRadius: radii.control, backgroundColor: colors.accent, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', shadowColor: colors.shadow, shadowOpacity: 0.12, shadowRadius: 14, shadowOffset: { width: 0, height: 6 } }, primaryButtonDisabled: { backgroundColor: colors.panelRaised, shadowOpacity: 0 }, primaryButtonText: { color: colors.onImage, fontSize: 15, fontWeight: '700' }, primaryButtonTextDisabled: { color: colors.muted }, primaryArrow: { color: colors.onImage, fontSize: 22 },
