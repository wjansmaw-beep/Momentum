  ...
  return (
    <ScrollView contentContainerStyle={styles.screenScroll} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.daySummary}>
        <View style={styles.daySummaryCount}><Text style={styles.daySummaryNumber}>{decisions.length}</Text></View>
        <View style={styles.flex}><Text style={styles.daySummaryEyebrow}>MOGELIJKE OPENINGEN</Text><Text style={styles.daySummaryBody}>Een rustig dagbeeld uit dezelfde selectie als Nu. Jij bepaalt welke tijd werkelijk van jou is.</Text></View>
      </View>
      <View style={styles.timeline}>
        {decisions.map((moment) => {
...
function BottomNav({ surface, onChange }: { surface: Surface; onChange: (surface: Surface) => void }) {
  ...
  return <View style={styles.bottomNav}>{items.map((item) => {
    ...
    return <Pressable key={item.id} accessibilityRole="tab" accessibilityState={{ selected: active }} onPress={() => onChange(item.id)} style={styles.navItem}><View style={[styles.navIconShell, active && styles.navIconShellActive]}><Text style={[styles.navIcon, active && styles.navActive]}>{item.icon}</Text></View><Text style={[styles.navLabel, active && styles.navActive]}>{item.label}</Text></Pressable>;
  })}</View>;
}
...
const styles = StyleSheet.create({
  ...
  onboardingChoiceSelected: { borderColor: colors.green, backgroundColor: colors.accentSoft },
  ...
  resumeCard: { borderRadius: 20, borderWidth: 1, borderColor: colors.accentLine, backgroundColor: colors.accentSoft, padding: 15, marginBottom: 14 },
  ...
  primaryButton: { minHeight: 56, borderRadius: radii.control, backgroundColor: colors.green, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', shadowColor: colors.shadow, shadowOpacity: 0.12, shadowRadius: 14, shadowOffset: { width: 0, height: 6 } }, primaryButtonText: { color: colors.onImage, fontSize: 15, fontWeight: '700' }, primaryArrow: { color: colors.onImage, fontSize: 22 },
  ...
  whyButton: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 4 }, whyButtonText: { color: colors.muted, fontSize: 13 }, whyChevron: { color: colors.gold, fontSize: 18 }, whyPanel: { borderRadius: 18, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.accentSoft, padding: 15, gap: 8 }, whyReason: { color: colors.bone, fontSize: 12, lineHeight: 18 }, proofNote: { color: colors.muted, fontSize: 9, lineHeight: 14, marginTop: 3 }, quietAction: { minHeight: 38, alignItems: 'center', justifyContent: 'center' }, quietActionText: { color: colors.muted, fontSize: 12 },
  silentCard: { minHeight: 520, borderRadius: 30, borderWidth: 1, borderColor: colors.line, padding: 24, justifyContent: 'center', backgroundColor: colors.panel }, silentTitle: { color: colors.bone, fontSize: 36, lineHeight: 42, fontWeight: '300' },
  momentMakerCard: { marginTop: 18, borderRadius: 25, borderWidth: 1, borderColor: colors.accentLine, backgroundColor: colors.accentSoft, padding: 17 }, momentMakerHeader: { flexDirection: 'row', alignItems: 'center', gap: 9, marginBottom: 11 }, momentMakerEyebrow: { color: colors.green, fontSize: 9, letterSpacing: 1.2, fontWeight: '700' }, momentMakerTitle: { color: colors.bone, fontSize: 19, lineHeight: 24, fontWeight: '600' }, momentMakerBody: { color: colors.muted, fontSize: 11, lineHeight: 17, marginTop: 7, marginBottom: 13 },
  spaceCard: { marginTop: 16, minHeight: 90, borderRadius: 25, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel, padding: 16, flexDirection: 'row', alignItems: 'center', shadowColor: colors.shadow, shadowOpacity: 0.07, shadowRadius: 12, shadowOffset: { width: 0, height: 5 } }, spaceIcon: { width: 45, height: 45, borderRadius: 23, borderWidth: 1, borderColor: colors.gold, alignItems: 'center', justifyContent: 'center', marginRight: 13 }, spaceIconText: { color: colors.gold, fontSize: 19 }, spaceTitle: { color: colors.bone, fontSize: 17, fontWeight: '600' }, spaceBody: { color: colors.muted, fontSize: 11, lineHeight: 16, marginTop: 3 }, arrow: { color: colors.gold, fontSize: 25 },
  daySummary: { borderRadius: radii.card, borderWidth: 1, borderColor: colors.softLine, backgroundColor: 'rgba(252,250,245,0.72)', padding: 16, marginBottom: 30, flexDirection: 'row', alignItems: 'center', gap: 14 }, daySummaryCount: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.accentSoft, borderWidth: 1, borderColor: colors.accentLine, alignItems: 'center', justifyContent: 'center' }, daySummaryNumber: { color: colors.green, fontSize: 23, lineHeight: 26, fontWeight: '600' }, daySummaryEyebrow: { color: colors.green, fontSize: 10, letterSpacing: 1.25, fontWeight: '700' }, daySummaryBody: { color: colors.muted, fontSize: 12, lineHeight: 18, marginTop: 4 }, timeline: { gap: 0 }, timelineRow: { width: '100%' }, timelineContent: { paddingBottom: 27 }, dayMomentHeader: { flexDirection: 'row', alignItems: 'center', gap: 9, marginBottom: 10, paddingHorizontal: 2 }, dayMomentMark: { width: 20, height: 3, borderRadius: 2 }, timelineTime: { color: colors.muted, fontSize: 10, letterSpacing: 1.15, fontWeight: '700' }, dayCardImage: { minHeight: 220, justifyContent: 'flex-end', borderRadius: radii.card, overflow: 'hidden', shadowColor: colors.shadow, shadowOpacity: 0.12, shadowRadius: 16, shadowOffset: { width: 0, height: 8 } }, dayCardImageStyle: { borderRadius: radii.card }, dayCardCopy: { padding: 19, paddingTop: 62 }, dayCardTitle: { color: colors.onImage, fontSize: 27, lineHeight: 32, fontWeight: '700', fontFamily: appFont, letterSpacing: -0.4 }, dayCardPromise: { color: colors.onImageMuted, fontSize: 13, lineHeight: 19, marginTop: 7, maxWidth: 360 }, dayCardMeta: { color: colors.onImage, fontSize: 11, lineHeight: 16, fontWeight: '600', marginTop: 14 }, quietDay: { borderRadius: radii.control, borderWidth: 1, borderColor: colors.softLine, backgroundColor: 'rgba(252,250,245,0.72)', padding: 17, marginTop: 2 }, quietDayTitle: { color: colors.bone, fontSize: 15, fontWeight: '700' }, quietDayBody: { color: colors.muted, fontSize: 11, lineHeight: 17, marginTop: 5 },
  ...
  bottomNav: { position: 'absolute', left: 18, right: 18, bottom: 12, minHeight: 66, borderRadius: radii.card, borderWidth: 1, borderColor: colors.softLine, backgroundColor: 'rgba(252,250,245,0.94)', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 5, shadowColor: colors.shadow, shadowOpacity: 0.10, shadowRadius: 20, shadowOffset: { width: 0, height: 9 } }, navItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 2, minHeight: 54, borderRadius: radii.control, ...(Platform.OS === 'web' ? ({ outlineStyle: 'none' } as any) : {}) }, navIconShell: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, navIconShellActive: { backgroundColor: colors.accentSoft }, navIcon: { color: colors.muted, fontSize: 15 }, navLabel: { color: colors.muted, fontSize: 10, fontWeight: '600' }, navActive: { color: colors.green },
  backButton: { alignSelf: 'flex-start', minHeight: 44, justifyContent: 'center', marginBottom: 10, paddingHorizontal: 13, borderRadius: 22, borderWidth: 1, borderColor: colors.line, backgroundColor: 'rgba(252,250,245,0.90)' }, backButtonText: { color: colors.bone, fontSize: 13, fontWeight: '600' }, detailHero: { height: 390, justifyContent: 'flex-end', marginHorizontal: -20, marginTop: -62, marginBottom: 26 }, detailHeroImage: { borderBottomLeftRadius: radii.hero, borderBottomRightRadius: radii.hero }, detailHeroCopy: { padding: 22, paddingTop: 112 }, detailTitle: { color: colors.onImage, fontSize: 38, lineHeight: 43, fontWeight: '700', fontFamily: appFont, letterSpacing: -1, marginTop: 13 }, detailPromise: { color: colors.onImageMuted, fontSize: 15, lineHeight: 22, marginTop: 10 }, wonderHeadline: { color: colors.green, fontSize: 10, letterSpacing: 1.35, fontWeight: '700' }, wonderLarge: { color: colors.bone, fontSize: 20, lineHeight: 28, fontWeight: '600', fontFamily: appFont, marginTop: 9 }, factStrip: { flexDirection: 'row', gap: 14, borderWidth: 1, borderColor: colors.line, borderRadius: radii.control, backgroundColor: colors.panel, paddingHorizontal: 14, paddingVertical: 15, marginVertical: 20 },
  ...
  placeKnowledgeCard: { borderRadius: 22, borderWidth: 1, borderColor: colors.accentLine, backgroundColor: colors.accentSoft, padding: 17, marginBottom: 20 }, placeKnowledgeLabel: { color: colors.green, fontSize: 9, letterSpacing: 1.35, fontWeight: '700' }, placeKnowledgeTitle: { color: colors.bone, fontSize: 20, lineHeight: 25, fontWeight: '700', marginTop: 8 }, placeKnowledgeBody: { color: colors.bone, fontSize: 12, lineHeight: 19, marginTop: 9 }, placeKnowledgeSource: { fontSize: 10, fontWeight: '700', marginTop: 12 },
