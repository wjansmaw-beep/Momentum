...
const styles = StyleSheet.create({
  ...
  daySummary: { borderRadius: radii.card, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel, padding: 17, marginBottom: 26 }, daySummaryTitle: { color: colors.bone, fontSize: 17, fontWeight: '700' }, daySummaryBody: { color: colors.muted, fontSize: 12, lineHeight: 18, marginTop: 5 }, timeline: { gap: 0 }, timelineRow: { flexDirection: 'row' }, timelineRail: { width: 28, alignItems: 'center' }, timelineDot: { width: 10, height: 10, borderRadius: 5, marginTop: 3 }, timelineLine: { flex: 1, width: 1, backgroundColor: colors.line, marginVertical: 7 }, timelineContent: { flex: 1, paddingBottom: 20 }, timelineTime: { color: colors.gold, fontSize: 11, letterSpacing: 1.2, fontWeight: '700', marginBottom: 9 }, dayCardImage: { minHeight: 190, justifyContent: 'flex-end' }, dayCardImageStyle: { borderRadius: radii.card }, dayCardCopy: { padding: 17 }, dayCardTitle: { color: colors.bone, fontSize: 25, lineHeight: 31, fontWeight: '700', fontFamily: appFont }, dayCardPromise: { color: 'rgba(243,240,233,0.8)', fontSize: 13, lineHeight: 19, marginTop: 6, maxWidth: 330 }, dayCardMeta: { color: colors.bone, fontSize: 12, marginTop: 12 }, quietDay: { borderTopWidth: 1, borderColor: colors.line, paddingTop: 20, marginTop: 2 }, quietDayTitle: { color: colors.bone, fontSize: 16, fontWeight: '700' }, quietDayBody: { color: colors.muted, fontSize: 12, lineHeight: 18, marginTop: 5 },
  ...
  bottomNav: { position: 'absolute', left: 14, right: 14, bottom: 10, minHeight: 70, borderRadius: radii.card, borderWidth: 1, borderColor: colors.line, backgroundColor: 'rgba(20,24,22,0.97)', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 7 }, navItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 5, minHeight: 60 }, navIcon: { color: colors.muted, fontSize: 17 }, navLabel: { color: colors.muted, fontSize: 10, fontWeight: '600' }, navActive: { color: colors.green },
