...
const styles = StyleSheet.create({
  ...
  bottomNav: { position: 'absolute', left: 14, right: 14, bottom: 10, minHeight: 70, borderRadius: radii.card, borderWidth: 1, borderColor: colors.line, backgroundColor: 'rgba(252,250,245,0.96)', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 7, shadowColor: colors.shadow, shadowOpacity: 0.12, shadowRadius: 18, shadowOffset: { width: 0, height: 8 } }, navItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 4, minHeight: 56, borderRadius: radii.control }, navItemActive: { backgroundColor: colors.accentSoft }, navIcon: { color: colors.muted, fontSize: 16 }, navLabel: { color: colors.muted, fontSize: 10, fontWeight: '600' }, navActive: { color: colors.green },
