...
const styles = StyleSheet.create({
  ...
  readySummary: { minHeight: 76, borderRadius: 22, borderWidth: 1, borderColor: 'rgba(164,197,93,0.28)', backgroundColor: 'rgba(164,197,93,0.06)', padding: 15, marginBottom: 24, flexDirection: 'row', alignItems: 'center', gap: 12 },
