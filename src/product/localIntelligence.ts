...
export function buildToday(context: PrototypeContext, liveExperiences: Experience[] = [], learning?: PersonalLearningContext, availability?: AvailabilityWindow[], catalogExperiences: Experience[] = experiences): TodayDecision[] {
  ...
  const used: string[] = [];
  const candidatePool = [...liveExperiences, ...catalogExperiences];
