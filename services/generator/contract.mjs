...
export function validateRequest(value) {
  ...
  if (!intent && !clarificationTerms) return { ok: false, error: 'Een expliciete richting ontbreekt.' };
  ...
  return { ok: true, value: { intent, clarificationTerms, domains, contractVersion: 'experience-draft-v1', context: { dayPart: context.dayPart, company: context.company, availableMinutes, hasKettlebell: Boolean(context.hasKettlebell) } } };
}
